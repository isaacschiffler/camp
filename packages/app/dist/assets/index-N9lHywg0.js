 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function At(r){return Vt({...r,state:!0,attribute:!1})}const U=S`
  body {
...
`;var Yr=Object.defineProperty,Wr=(r,t,e,s)=>{for(var i=void 0,n=r.length-1,o;n>=0;n--)(o=r[n])&&(i=o(t,e,i)||i);return i&&Yr(t,e,i),i};function Gr(r){vs.relay(r,"auth:message",["auth/signout"])}function Kr(r){const e=r.target.checked;vs.relay(r,"darkmode",{checked:e})}const Lt=class Lt extends E{constructor(){super(...arguments),this.userid="camper",this._authObserver=new k(this,"backpack:auth")}render(){return v`
      <header>
        <a href="/">
    ...
    `];let ce=Ht;var Qr=Object.defineProperty,Xr=(r,t,e,s)=>{for(var i=void 0,n=r.length-1,o;n>=0;n--)(o=r[n])&&(i=o(t,e,i)||i);return i&&Qr(t,e,i),i};const Se=class Se extends E{render(){return v`
      <header class="image">
    ...
    `];let jt=Se;Xr([Vt({type:String})],jt.prototype,"image_url");const zt=class zt extends E{constructor(){super(...arguments),this._authObserver=new k(this,"backpack:auth"),this._user=new C.User}render(){return v`
      <main class="page">
    ...
    `}connectedCallback(){super.connectedCallback(),this._authObserver.observe(({user:t})=>{t&&(this._user=t)})}};zt.uses=nt({"camp-site":jt}),zt.styles=[N,U,S`
      .thr-sections {
        display: grid;
    ...
    `];let he=zt;const Pe=class Pe extends E{constructor(){super(...arguments),this._authObserver=new k(this,"backpack:auth"),this._user=new C.User}render(){return v`
      <main class="page">
        <section class="thr-sections">
          <header class="nav">
            <a href="/app/step1">

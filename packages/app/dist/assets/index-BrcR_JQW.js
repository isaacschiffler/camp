 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const qr={attribute:!0,type:String,converter:Rt,reflect:!1,hasChanged:xe},Vr=(r=qr,t,e)=>{const{kind:s,metadata:i}=e;let n=globalThis.litPropertyMetadata.get(i);if(n===void 0&&globalThis.litPropertyMetadata.set(i,n=new Map),n.set(e.name,r),s==="accessor"){const{name:o}=e;return{set(l){const a=t.get.call(this);t.set.call(this,l),this.requestUpdate(o,a,r)},init(l){return l!==void 0&&this.P(o,void 0,r),l}}}if(s==="setter"){const{name:o}=e;return function(l){const a=this[o];t.call(this,l),this.requestUpdate(o,a,r)}}throw Error("Unsupported decorator location: "+s)};function Bt(r){return(t,e)=>typeof e=="object"?Vr(r,t,e):((s,i,n)=>{const o=i.hasOwnProperty(n);return i.constructor.createProperty(n,o?{...s,wrapped:!0}:s),o?Object.getOwnPropertyDescriptor(i,n):void 0})(r,t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Yr=Object.defineProperty,Wr=(r,t,e,s)=>{for(var i=void 0,n=r.length-1,o;n>=0;n--)(o=r[n])&&(i=o(t,e,i)||i);return i&&Yr(t,e,i),i};function Gr(r){vs.relay(r,"auth:message",["auth/signout"])}function Kr(r){const e=r.target.checked;vs.relay(r,"darkmode",{checked:e})}const jt=class jt extends E{constructor(){super(...arguments),this.userid="camper",this._authObserver=new k(this,"backpack:auth")}render(){return y`
      <header>
        <a href="/">
    ...
    `}connectedCallback(){super.connectedCallback(),this._authObserver.observe(({user:t})=>{t&&t.username!==this.userid&&(this.userid=t.username)})}static initializeOnce(){function t(e,s){e.classList.toggle("darkmode",s)}document.body.addEventListener("darkmode",e=>{var s;return t(e.currentTarget,(s=e.detail)==null?void 0:s.checked)})}};jt.uses=nt({"mu-dropdown":mr.Element}),jt.styles=[U,N,S`
      nav {
        display: flex;
        flex-direction: column;
    ...
    `];let he=Pe;var tn=Object.defineProperty,en=Object.getOwnPropertyDescriptor,Vt=(r,t,e,s)=>{for(var i=s>1?void 0:s?en(t,e):t,n=r.length-1,o;n>=0;n--)(o=r[n])&&(i=(s?o(t,e,i):o(i))||i);return s&&i&&tn(t,e,i),i};function ls(r){const t={month:"long",day:"numeric",timeZone:"UTC"},e=new Intl.DateTimeFormat("en-US",t).format(r);return sn(e)}function sn(r){const[t,e]=r.split(" "),s=parseInt(e,10);let i;return s===1||s===21||s===31?i="st":s===2||s===22?i="nd":s===3||s===23?i="rd":i="th",`${t} ${s}${i}`}const Ht=class Ht extends Vs{constructor(){super("backpack:model"),this.mode="view"}get trip(){return this.model.trip}get _trip(){if(this.trip)return{title:this.trip.title,startDate:new Date(this.trip.startDate),endDate:new Date(this.trip.endDate),region:this.trip.location.region,members:this.trip.members.map(t=>t.name),campsites:this.trip.location.campsite,activities:this.trip.activities,gear:this.trip.gear}}render(){var t;return this.trip?y`
        <section
    ...
    `];let q=Ht;Vt([Bt()],q.prototype,"tripid",2);Vt([Bt({reflect:!0})],q.prototype,"mode",2);Vt([qt()],q.prototype,"trip",1);Vt([qt()],q.prototype,"_trip",1);const Ce=class Ce extends E{constructor(){super(...arguments),this._authObserver=new k(this,"backpack:auth"),this._user=new R.User}render(){return y`
      <main class="page">
        <section class="thr-sections">
          <header class="nav">
            <a href="/app">
